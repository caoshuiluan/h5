<template>
 <div  class="container">
    ...
    <div class="content">
      <div class="title" style="font-size:16px; text-align: left;margin-left:16px; height:50px"><b>商品收货信息</b></div>
   
        <div class='good-address'>
            <span class='leftOne'>收货地址</span>
        ...
        <div class="right-input">
            <input type="text"  placeholder="请输入商品具体收货地址">
        </div>
  </div>
  <div class="box-one"></div>
  <div class="middle">
    ...
    <div class="title"  ><b>就读高校信息</b></div>
        ...
        <Input class="rightTwo"  placeholder="请选择就读高校名称" />
        </div>
     <div class="collegesAdress" >
        <span class='leftThree'  >就读高校地址</span>
        <span class='rigthThree' ><input  value="请选择学校收款账户名" class="choice-school" ></span>
        </div>
</div >
    <div class="box-one"></div>
    <div  class="last">
            <div class="title" style="font-size:16px; text-align: left;margin-left:16px; height:50px" >就读高校信息补录</div>
            <div class='year'>
...
.good-address,.colleges,.collegesAdress,.year,.education,.schoolSystem,.school,.graduationYear,.major,.studentNumber{
  height: 50px;
  text-align: center;
  vertical-align: middle;
}
.leftOne,.leftTwo,.leftThree,.lfetFour,.leftFive,.leftSix,.leftSeven,.leftEight,.leftNine,.leftTen{
  font-size: 13px;
  color: #333333;
  position: absolute;
  left: 16px;
...
.right-input,.rigthThree,.rightEight,.rightNine,.rightTen{
  width: 223px;
	height: 42px;
